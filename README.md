...
- По умолчанию создается 20 фильмов, 75 жанров, 20 жанров к фильмам, 100 отзывов и 50 пользователей
- При регистрации, пароль хэшируется и недоступен для просмотра, так как его нельзя расшифровать
- Удобная главная страница. Каждый постер содержит название, оригинальное название, рейтинг и возрастное ограничение. При нажатии на карточку показывает полную информацию о фильме
- Рейтинг рассчитывается от отзывов (Сумма отзывов делённое на количество)
...
- `python app.py`
- При первом запуске программы app.py автоматически создаст базу данных и внесет в нее первичные данные (смотрите файл models/seed.py)
